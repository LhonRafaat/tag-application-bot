...
import { getSettings } from "./services/settingService.ts";
import { getUserProfile } from "./utils/utils.ts";
import { findAll, getMembersRanking } from "./services/memberService.ts";
import { getRequiredPoints } from "./services/settingService.ts";
import { getByGameName } from "./interactions/getByGameName.ts";
import { closeTicket } from "./interactions/closeTicket.ts";
import { getRegister } from "./interactions/getRegister.ts";
import { getStatus } from "./interactions/getStatus.ts";
import { vote } from "./interactions/vote.ts";
import { submitVote } from "./interactions/submitVote.ts";
import { register } from "./interactions/regsiter.ts";
import { setPoints } from "./interactions/setPoints.ts";
import { submitRegisterBf2 } from "./modal-submit/submitRegisterBf2.ts";
import { submitRegister } from "./modal-submit/submitRegister.ts";
import { subLinkAlt } from "./modal-submit/SubLinkAlt.ts";
import { linkAnotherAccount } from "./interactions/linkAnotherAccount.ts";
import { denyLinkAnotherAccount } from "./interactions/denyLinkAnotherAccount.ts";
import { registerBf2 } from "./interactions/registerBf2.ts";
import { myVotes } from "./interactions/myVotes.ts";
